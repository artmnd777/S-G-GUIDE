  ...
  return {
    reply_markup: {
      keyboard: [
        ...
        ['Новый диалог', 'Добавить обучение'],
        ['Примеры']
      ],
...
function menuText() {
  return [
    ...
    'Добавить обучение — быстро добавить прайс, скрипт или знание.',
...
function instructionText() {
  return [
    ...
    '',
    '4. Для обучения нажмите «Добавить обучение» и отправьте прайс, скрипт, правило или любой текст, который бот должен учитывать.',
    '',
